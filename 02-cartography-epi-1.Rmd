...
library(tidycensus)
library(tmap)
death <- read.table('../DATA/all-cause-mortality/allcause-2016-2018-clean.txt', sep ='\t',
...
library(tigris)
options(tigris_use_cache = TRUE)  # this saves data to make it quicker to run again in future
us <- counties(cb = TRUE,
                        resolution = '5m', 
                        year = 2018,
                        class = 'sf')
