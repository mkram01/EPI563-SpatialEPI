...
print_learn_objective('Disease Mapping IV')
```
...
b_point <- st_read('../SpatialEpi-2021/DATA/FultonInfantMortality/birth_points.gpkg') 

# This is points for deaths in Dekalb/Fulton county
d_point <- st_read('../SpatialEpi-2021/DATA/FultonInfantMortality/death_points.gpkg') 

# This is an outline of Dekalb/Fulton county to be used as a study 'window'
county <- st_read('../SpatialEpi-2021/DATA/FultonInfantMortality/DekalbFultonWindow.gpkg') 
...
```{r include = F}
# Ran above code and manually cache in .rds
#saveRDS(death_kde_adapt, 'myCache/death_kde_adapt.rds')
#saveRDS(birth_kde_adapt, 'myCache/birth_kde_adapt.rds')
death_kde_adapt <- readRDS('myCache/death_kde_adapt.rds')
birth_kde_adapt <- readRDS('myCache/birth_kde_adapt.rds')
```
...
```{r include = F}
# Another manual cache
#saveRDS(imr1000, 'myCache/imr1000.rds')
#saveRDS(imr2000, 'myCache/imr2000.rds')
#saveRDS(imr4000, 'myCache/imr4000.rds')
#saveRDS(imr8000, 'myCache/imr8000.rds')
#saveRDS(imradapt, 'myCache/imradapt.rds')

imr1000 <- readRDS('myCache/imr1000.rds')
imr2000 <- readRDS('myCache/imr2000.rds')
imr4000 <- readRDS('myCache/imr4000.rds')
imr8000 <- readRDS('myCache/imr8000.rds')
imradapt <- readRDS('myCache/imradapt.rds')
```
...
atl <- st_read('../SpatialEpi-2021/DATA/FultonInfantMortality/Fulton-Dekalb-covariates.gpkg') %>%
...
```{r include = F}
#manual cache
#bw.cache <- bw.gwss.average(atl, vars = c('pctPOV', 'pctNOHS', 'pctMOVE', 
#                              'pctOWNER_OCC', 'ICE_INCOME_all'),
#                adaptive = T)
#saveRDS(bw.cache, 'myCache/bw.cache.rds')
```

```{r echo=FALSE}
bw.cache <- readRDS('myCache/bw.cache.rds')
bw.cache
```
...
```{r include = F}
# manual cache
#saveRDS(atl.ss, 'myCache/atl-ss.rds')
atl.ss <- readRDS('myCache/atl-ss.rds')
```
...
#saveRDS(p.val, 'myCache/p-val.rds')
# Note the above was originally run with both pctPov and pctMove...here only showing pov
p.val <- readRDS('myCache/p-val.rds')

pov.pval <- p.val[, c(1, 3, 5, 7, 9)]
```
...
```{r include = F}
#saveRDS(p.val, 'myCache/p-val2var.rds')
p.val <- readRDS('myCache/p-val2var.rds')
```
