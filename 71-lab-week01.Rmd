...
mvc <- st_read(here::here('DATA','GA_MVC', 'ga_mvc.gpkg'))
hwy <- st_read(here::here('DATA','GA_MVC', 'ga_hwy.gpkg'))
trauma <- st_read(here::here('DATA','GA_MVC', 'trauma_centers.gpkg'))
```
...
```{r include = F}
hwy.aea <- st_transform(hwy, 5070)
trauma.aea <- st_transform(trauma, 5070)
```
