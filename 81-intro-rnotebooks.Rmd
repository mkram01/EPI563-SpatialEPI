...
## What is `rmarkdown` and why do we need it?
...
2.  Use the space *under* the `YAML` to type the objective or purpose of this analysis, and any introduction or background that is useful. I recommend using Headers to separate key parts of your work.
3.  Carry out your analysis, inserting code chunks, running them, and documenting them with free text as you go.

-   If you wish, you can see how the results look in HTML by clicking the *Visual* button at the top of the editor pane.
